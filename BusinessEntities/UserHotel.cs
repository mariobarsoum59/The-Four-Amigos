...
namespace BusinessEntities
{
    public static class UserHotel
    {
        ...
        public static IUser GetUser(string FirstName, string Surname, string Username, string Password, string userType)
        {
            if (user != null)  // ie is Factory is primed with an object. 
                return user;
            else
                return new User(FirstName, Surname, Username, Password, userType);
        }
