...
{
    public partial class formRequestCleaningSupplies : Form
    {
        private FormContainer fc;
        private IModel Model;
        List<IStockItem> IngredientOrder;
        public formRequestCleaningSupplies(FormContainer parent, IModel Model)
        {
            InitializeComponent();
            MdiParent = parent;
            fc = parent;
        ...
        private void formRequestCleaningSupplies_Load_1(object sender, EventArgs e)
        {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (Model.createStockOrder(date, total, "Cleaning", Model.CurrentUser.UserID))
            {
                Model.GetAllStockOrders();
